...
export declare function FloatingWhatsApp({ onClick, onSubmit, onClose, onNotification, onLoopDone, phoneNumber, accountName, avatar, statusMessage, chatMessage, placeholder, messageDelay, allowDefaultSubmit, openChatOnClick, allowClickAway, allowEsc, notification, notificationDelay, notificationLoop, notificationSound, notificationSoundSrc, notificationStyle, notificationClassName, buttonStyle, buttonClassName, chatboxHeight, chatboxStyle, chatboxClassName, sendButtonClassName, darkMode, style, className }: FloatingWhatsAppProps): JSX.Element;
